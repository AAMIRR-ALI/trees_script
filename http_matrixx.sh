...
echo -e "${blue}Keys cloning ${clear}"
git clone https://github.com/AAMIRR-ALI/keys.git vendor/lineage-priv/keys
...
lunch lineage_bladerunner-bp1a-userdebug && m installclean && m bacon
