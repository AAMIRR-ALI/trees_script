...
git clone git@github.com:AAMIRR-ALI/android_device_realme_bladerunner.git -b rise-stable device/realme/bladerunner
git clone git@github.com:AAMIRR-ALI/android_device_realme_sm8250-common.git -b rise-stable device/realme/sm8250-common
...
git clone git@github.com:RisingOSS-devices/vendor_realme_sm8250-common.git vendor/realme/sm8250-common --depth=1

echo -e "${blue}Hardware cloning ${clear}"
git clone git@github.com:AAMIRR-ALI/hardware_oplus.git -b rise-stable hardware/oplus
...
git clone git@github.com:AAMIRR-ALI/old_dolby.git hardware/dolby
